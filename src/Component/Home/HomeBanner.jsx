        ...
        <div className="items-center lg:flex ">
            <div className="w-full lg:w-1/2 ">
                <div className="lg:max-w-lg">
                    ...
                    <p className="mt-3 text-gray-600 dark:text-gray-400">Welcome to Contest Hub, the ultimate destination for creators and innovators! Transform your imagination into reality by participating in exciting contests, connecting with fellow creatives, and showcasing your talents to the world. </p>
